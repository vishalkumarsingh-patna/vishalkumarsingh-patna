...
I am a BCA student at CIMAGE Professional College, Patna, currently pivoting my focus toward the world of **DevOps and Infrastructure**. I believe that failure is just a data point for future success, and I am dedicated to mastering the tools that power the modern web.

---

### 🔭 What I’m working on:
- ☁️ Mastering **AWS** (EC2, S3, IAM) and Cloud Architecture.
- 🐳 Deep diving into **Docker** and Containerization.
- 🏗️ Building CI/CD pipelines to automate the boring stuff.
- 🐧 Strengthening my **Linux/Bash** scripting skills.

### 🛠️ Tech Stack:
- **Cloud:** AWS
- **DevOps:** GitHub Actions, Docker, Jenkins (Learning)
...
---
### 🖋️ Guestbook & Visits
![Profile Views](https://komarev.com/ghpvc/?username=vishalkumarsingh-patna&color=blue&style=flat-square&label=PROFILE+VIEWS)

Visiting my profile? **[Click here to leave your name and a message!](https://github.com/vishalkumarsingh-patna/vishalkumarsingh-patna/issues/new)** 🖋️
### 📫 Connect with me:
